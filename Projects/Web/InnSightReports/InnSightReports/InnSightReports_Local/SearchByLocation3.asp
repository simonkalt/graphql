...
Sub cmdPrintLocation_onclick
	...
	Else
		...
		window.frmViewLocation.target = "ifPrintReport"
		window.frmViewLocation.action = "reportlocation.asp?type=loc&mode=p"
		window.frmViewLocation.txtPrintLocationList.value = strLocationList
		window.frmViewLocation.submit
		'window.location.href = "ReportLocation.asp?LocationIDList=" & strLocationList
	End If
End Sub
...
Sub cmdPrintSummary_onclick
	...
	If intSelCnt = 0 Then
		MsgBox "You must select at least one record to view a report."
	Else
		window.frmViewSummary.target = "ifPrintReport"
		window.frmViewSummary.action = "reportlocationsummary.asp?type=loc&mode=p"
		window.frmViewSummary.txtPrintSummaryList.value = strLocationList
		window.frmViewSummary.submit
...
<body vLink=black aLink=black link=black bgColor=silver leftMargin=0 topMargin=0 marginwidth="0" marginheight="0"><!--#include file = "Header.inc" ---> 
...
<table width=760 border=0 cellpadding=0 cellspacing=0>
  <tr>
    <td><p style="margin-left: 5px; font-family: Tahoma; font-size: 11">Search:&nbsp;<INPUT id=txtSelect style="WIDTH: 705px; HEIGHT: 22px; BACKGROUND-COLOR: #F9D568" name=txtSelect> 
	</p>
	</td>
   </tr>
	<tr>
...
--> 
	...
	<td>
	<table border=1 cellpadding=2 cellspacing=0 height=85>
	<tr>
	<td>
