...
<style>
<!--
	.Button_Normal		{ font-family: tahoma; font-size: 11px; width: 44px;border-color:silver;border-style:solid;border-width:1px;background-color:silver;height:17px }
	.Button_abNormal	{ font-family: tahoma; font-size: 11px; width: 90px;border-color:silver;border-style:solid;border-width:1px;background-color:silver;height:17px }
...
<body onclick="javascript:doCheckAID(window.event.srcElement.id)" id="bdy" bgcolor="#FFFFE1" topmargin="0" bottommargin="0" leftmargin="0" rightmargin="0" style="border-style:solid;border-color:black;border-width:1px" onload="return window_onload()">
	<table id="tbl1" width="100%" cellpadding="3">
		<tr>
		...
		<tr bgcolor="silver" style="height:14px;overflow:hidden">
			...
			<table cellpadding="0" cellspacing="0" border="0" bgcolor="silver">
				...
				<td style="border-right-style:ridge;border-width:1px;width:4px"></td>
				<td>
				...
				<td style="border-color:silver;border-right-style:ridge;border-width:1px;border-left-width:1px;border-left-style:solid;border-top-width:1px;border-top-style:solid;border-bottom-width:1px;border-bottom-style:solid" id="tdRem"><input type="button" id="cmdReminder" value="Add Reminder" class="Button_abNormal" onmouseover="window.tdRem.style.borderStyle='outset';window.tdRem.style.borderColor=''" onmouseout="window.tdRem.style.borderStyle='solid';window.tdRem.style.borderColor='silver';window.tdRem.style.borderRightStyle='ridge'" onmouseup="window.tdRem.style.borderStyle='solid';window.tdRem.style.borderColor='silver';window.tdRem.style.borderRightStyle='ridge'"></td>
				<td style="border-right-style:ridge;border-width:1px"><input type="button" id="cmdPrint" value="Print" class="Button_Normal"></td>
				<td style="border-right-style:ridge;border-width:1px"><input type="button" id="cmdEdit" value="Edit" class="Button_Normal"></td>
				<td style="border-right-style:ridge;border-width:1px"><input type="button" id="cmdDelete" value="Delete" class="Button_Normal"></td>
				<td style="border-right-style:ridge;border-width:1px"><input type="button" id="cmdCopy" value="Copy" class="Button_Normal"></td>
				<td style="border-right-style:ridge;border-width:1px"><input type="button" id="cmdGTL" value="Letter" class="Button_Normal" title="Guest Letter"></td>
				<td style="border-right-style:ridge;border-width:1px"><input type="button" id="cmdHide" value="Exit" style="color:red" class="Button_Normal" onclick="parent.tooltip.style.visibility='hidden';"></td>
				<td>
					<table width="100%" cellspacing="2" cellpadding="0" topmargin="0">
					  <tr>
						<td width="20px" align="center" style="border-width:1px;border-color:silver;border-style:solid" onmouseover="this.style.borderStyle='outset';this.borderColor='';" onmouseout="this.style.borderStyle='solid';this.borderColor='silver';" onmousedown="this.style.borderStyle='inset';" onmouseup="this.style.borderStyle='solid';this.borderColor='silver';">
							<img src="images\prev.gif" id="cmdUP" title="Show Previous Task" WIDTH="16" HEIGHT="16">
						</td>
						<td width="20px" align="center" style="border-width:1px;border-color:silver;border-style:solid" onmouseover="this.style.borderStyle='outset';this.borderColor='';" onmouseout="this.style.borderStyle='solid';this.borderColor='silver';" onmousedown="this.style.borderStyle='inset';" onmouseup="this.style.borderStyle='solid';this.borderColor='silver';">
...
<script language="javascript">
	...
	function doCheckAID(s)
	{
		...
		{
			if(checkAID(document.all("txtAppointmentID").value))
				{
				switch(s)
					{
					case "cmdUP":
						{
							...
							if (i > 0)
								parent.window.frames("frameTaskPad" + parent.intATF).showTextActivate(ar[i-1]);
